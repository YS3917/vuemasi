        ...
        <div class="swiper-container sw-bevarage">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <a href="#">
                <img v-bind:src="require('@/assets/images/menu_slide01.png')" alt="">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#">
                <img v-bind:src="require('@/assets/images/menu_slide02.png')" alt="">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#">
                <img v-bind:src="require('@/assets/images/menu_slide03.png')" alt="">
              </a>
            </div>
          </div>
          <!-- 좌우 버튼 -->
